...
export function InviteCard({ name, elapsedMs }: { name: string; elapsedMs: number }) {
  const { t } = useLocale();
  ...
  return (
    ...
    >
      ...
      >
        ...
        {elapsedMs > 0 && (
          <div className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-[var(--color-accent)]/25 px-3 py-1 text-[11px] font-semibold text-[var(--color-text)]">
